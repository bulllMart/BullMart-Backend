...
class NSELive {
  ...
  async referenceRates(type) {
    //commodityspotrates,commodityfuturesrates,currencyrates,interestrates
    return this.get(`/refrates?index=${type}`);
  }
  async weekHighLow52Count() {
    //get count of 52 week high and low
    return this.get(`/live-analysis-52weekhighstock`);
  }
